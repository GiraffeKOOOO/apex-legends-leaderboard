...
function ThirdPlayerBanner(props) {
	return (
		<>
			<div id="third-player-banner" className="border-2 border-color-black grid grid-cols-3">
				<div id="player-banner" className="col-span-2 mx-auto">
					<img src={wraithBanner} className="h-[250px]" alt="third-player-banner" />
...
export default ThirdPlayerBanner;
